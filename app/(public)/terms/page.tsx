      ...
      <div className="rounded-xl border border-border bg-card p-6 space-y-8">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-2">
            ...
            <li><span className="text-foreground font-medium">Video Content:</span> Videos displayed within PatchPulse are embedded from YouTube and remain the property of their respective creators and copyright holders. We do not host, modify, or claim ownership of any video content.</li>
