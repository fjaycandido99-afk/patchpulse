...
export function VideosFeed({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="-mx-4 px-2 py-2 bg-background/95 backdrop-blur-md border-b border-white/5 md:mx-0 md:px-0 md:py-0 md:bg-transparent md:backdrop-blur-none md:border-0">
