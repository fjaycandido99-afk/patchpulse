      ...
      <div className={`relative overflow-hidden bg-zinc-900 ${bleed ? '-mx-4 w-[calc(100%+2rem)]' : 'rounded-xl'}`}>
        ...
        {showPreview && (
          <iframe
            ...
            style={{ WebkitTransform: 'translateZ(0)', transform: 'translateZ(0)', position: 'absolute', inset: 0 }}
