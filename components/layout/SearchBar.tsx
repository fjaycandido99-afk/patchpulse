  ...
  return (
    <>
      ...
      <button
        ...
        className={`flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 border border-white/15 text-muted-foreground text-sm hover:bg-white/10 hover:border-white/25 transition-all ${className}`}
      >
